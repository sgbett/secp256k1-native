...
Proposed follow-on to **#25** (bare-metal dudect verification). Assign an issue
number and rename to `NN-reference-machine-nix.md` when filed.
...
- Issue: file a follow-on to #25 and renumber this plan `NN-…`.
